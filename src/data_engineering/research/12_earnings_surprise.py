...
async def fetch_balance_sheet_for_ticker(session, semaphore, ticker):
    ...
    async with semaphore:
        await asyncio.sleep(0.35)  # Pace requests to avoid FMP rate limit
...
def save_balance_sheets_to_lake(spark, pandas_df):
    ...
    """
    logger.info(f"💾 Saving {pandas_df.shape[0]} earnings surprise records to {Paths.SP500_EARNINGS_SURPRISE}...")
    ...
    try:
        ...
        sdf.write.format("delta") \
            ...
            .save(Paths.SP500_EARNINGS_SURPRISE)
...
def main():
    setup_logging()
    logger.info("🚀 Starting Job: List SP500 Earnings Surprise Ingestion")
    ...
    try:
        ...
        cache_file = 'local_earnings_surprise_cache.parquet'
        if os.path.exists(cache_file):
            ...
            logger.info("⏱️ Fetching earnings surprises... This may take a few minutes.")
            ...
            logger.info(f"📊 Processed a total of {df_bs.shape[0]} earnings surprise rows.")
