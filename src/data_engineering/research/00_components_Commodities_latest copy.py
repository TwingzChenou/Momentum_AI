...
def list_sp500_history():
    ...
    url = f"{BASE_URL}/commodities-list?apikey={FMP_API_KEY}"
...
def save_history_to_lake(spark, pandas_df):
    ...
    """
    logger.info(f"💾 Saving History to {Paths.COMMODITIES_LIST_TICKERS} with {pandas_df.shape[0]} rows...")
    ...
    try:
        ...
        sdf.write.format("delta") \
            .mode("overwrite") \
            .save(Paths.COMMODITIES_LIST_TICKERS)
